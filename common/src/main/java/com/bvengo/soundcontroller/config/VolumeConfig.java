...
public class VolumeConfig {
    ...
    private VolumeConfig() {
        soundVolumes = new java.util.HashMap<>();
        updateVolumes();
    }
    ...
    public void resetAllToDefault() {
        for (VolumeData data : soundVolumes.values()) {
            data.setVolume(VolumeData.DEFAULT_VOLUME);
        }
        save();
        updateVolumes();
    }

    public java.util.Set<String> getDisabledCategories() {
