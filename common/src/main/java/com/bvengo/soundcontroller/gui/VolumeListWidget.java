 ...
 */
public class VolumeListWidget extends ContainerObjectSelectionList<VolumeListEntry> {
    private static final int rowWidth = VolumeWidgetEntry.totalWidth;
    private static final int rowHeight = 25;

    public VolumeListWidget(Minecraft client, int width, int height, int top) {
        super(client, width, height, top, rowHeight);
        this.centerListVertically = false;
    }

    public void addWidgetEntry(VolumeListEntry widget) {
