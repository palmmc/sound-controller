 ...
 */
public class VolumeWidgetEntry extends VolumeListEntry {
    ...
    public VolumeWidgetEntry(VolumeData volumeData, Screen screen, Options options, int depth) {
    ...
    private void addSlider() {
        ...
        this.volumeSlider = volumeOption.createButton(options, 0, 0, sliderWidth - depth * 12);
    }
